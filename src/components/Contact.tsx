              ...
              {[
                {
                  icon: MapPin,
                  title: 'Visit Us',
                  content: 'Dumri, Jharkhand - 825311',
                  color: 'blue',
                ...
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                >
                  <Card className={`p-8 border-t-4 border-t-${item.color}-600 hover:shadow-2xl transition-all h-full cursor-pointer group`}>
                    <div className={`w-16 h-16 bg-${item.color}-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                      <item.icon className={`w-8 h-8 text-${item.color}-600`} />
                    </div>
                    <h3 className="text-xl font-bold text-slate-900 mb-3">{item.title}</h3>
                    <p className="text-slate-600 mb-4 leading-relaxed">{item.content}</p>
                    <div className={`text-${item.color}-600 font-semibold flex items-center gap-2 group-hover:gap-3 transition-all`}>
                      {item.action}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  email: 'students@dumricollege.edu',
                ...
                },
                {
                  ...
                  email: 'placements@dumricollege.edu',
              ...
              {[
                {
                  ...
                  answer: 'Admission requirements vary by program. Generally, you need to have completed 10+2 for undergraduate programs and a bachelor\'s degree for postgraduate programs. Entrance exams and interviews are part of the selection process.',
                },
                {
                ...
                },
                {
                  ...
                  answer: 'We maintain a 98% placement rate with top companies recruiting from our campus. Our dedicated placement cell provides training, career counseling, and placement assistance to all students.',
                },
                {
                  question: 'Are there international exchange programs?',
                  answer: 'Yes, we have partnerships with 50+ international universities offering semester exchange programs, research collaborations, and cultural exchange opportunities for eligible students.',
                },
              ].map((faq, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <Card className="p-8 hover:shadow-xl transition-all cursor-pointer group bg-white">
                    <div className="flex items-start gap-4">
                      <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600 transition-colors">
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {[
                { icon: Facebook, name: 'Facebook', color: 'blue', handle: '@dumricollege' },
                { icon: Twitter, name: 'Twitter', color: 'sky', handle: '@dumricollege' },
                { icon: Instagram, name: 'Instagram', color: 'pink', handle: '@dumricollege' },
                { icon: Linkedin, name: 'LinkedIn', color: 'indigo', handle: 'Dumri College' },
                { icon: Youtube, name: 'YouTube', color: 'red', handle: 'Dumri College Official' },
              ].map((social, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <Card className={`p-8 text-center hover:shadow-2xl transition-all cursor-pointer border-t-4 border-t-${social.color}-600 group`}>
