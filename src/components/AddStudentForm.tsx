...
export function AddStudentForm() {
  ...
  const validateForm = () => {
    ...
    if (!formData.applyingForClass) validationErrors.applyingForClass = 'Applying for class is required';
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}>
                          ...
                          <select
                            ...
                            className={getErrorFieldClass('w-full h-12 px-4 border-2 border-gray-200 rounded-xl bg-white focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 transition-all outline-none text-gray-700', 'applyingForClass')}
                            required
                          >
      ...
      <div className="space-y-6">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <ReviewField label="Blood Group" value={bloodGroupName} />
            <ReviewField label="Religion" value={religionName} />
            <ReviewField label="Caste" value={casteName} />
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* <ReviewField label="Guardian Occupation" value={formData.guardianOccupation} /> */}
            <ReviewField label="Guardian Address" value={formData.guardianAddress} required fullWidth />
          </div>
        </ReviewSection>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <DocumentPreview file={documents.photo} label="Photo" />
            <DocumentPreview file={documents.casteCertificate} label="Caste Certificate" />
            <DocumentPreview file={documents.schoolLeaving} label="School Leaving" />
            <DocumentPreview file={documents.admitCard} label="Admit Card" />
            <DocumentPreview file={documents.marksheet} label="Marksheet" />
            <DocumentPreview file={documents.aadharCard} label="Aadhaar Card" />
          </div>
        </ReviewSection>
      </div>
    </motion.div>
...
const DocumentPreview: React.FC<DocumentPreviewProps> = ({ file, label }) => {
