...
import { Camera, Image as ImageIcon, Video, Calendar, Award, Music, Palette, Trophy, Users, Heart, Sparkles, Play, MapPin, Building } from 'lucide-react';
...
export function Gallery() {
  ...
  const eventImages = [
    { url: 'https://images.unsplash.com/photo-1643199032520-99230e970fb9?w=800&q=80', title: 'Annual Convocation 2025', category: 'Events', date: 'March 15, 2025' },
    { url: 'https://images.unsplash.com/photo-1759456629213-3db5a7bb53ae?w=800&q=80', title: 'TechFest Innovation Fair', category: 'Events', date: 'February 10, 2025' },
    { url: 'https://images.unsplash.com/photo-1686213011371-2aff28a08f16?w=800&q=80', title: 'Placement Drive 2025', category: 'Career', date: 'January 20, 2025' },
  ];

  const campusImages = [
    { url: 'https://images.unsplash.com/photo-1670111482157-c5ecbba142a7?w=800&q=80', title: 'Main Academic Block', category: 'Campus' },
    { url: 'https://images.unsplash.com/photo-1588618319407-948d4424befd?w=800&q=80', title: 'Central Library', category: 'Facilities' },
    { url: 'https://images.unsplash.com/photo-1733426509854-10931d84009a?w=800&q=80', title: 'Science Laboratory', category: 'Facilities' },
    { url: 'https://images.unsplash.com/photo-1701448149957-b96dbd1926ff?w=800&q=80', title: 'Engineering Workshop', category: 'Facilities' },
    { url: 'https://images.unsplash.com/photo-1767319257862-e5c5aeb1c628?w=800&q=80', title: 'Research Center', category: 'Research' },
    { url: 'https://images.unsplash.com/photo-1765294064326-036a233f9f49?w=800&q=80', title: 'Campus Aerial View', category: 'Campus' },
  ];

  const studentLife = [
    { url: 'https://images.unsplash.com/photo-1763890498955-13f109b2fbd7?w=800&q=80', title: 'Students in Campus', category: 'Student Life' },
    { url: 'https://images.unsplash.com/photo-1664273891579-22f28332f3c4?w=800&q=80', title: 'Study Group', category: 'Student Life' },
    { url: 'https://images.unsplash.com/photo-1766459710529-c9fdb8023ecb?w=800&q=80', title: 'Sports Day', category: 'Sports' },
    { url: 'https://images.unsplash.com/photo-1766297248027-864589dbd336?w=800&q=80', title: 'Laboratory Work', category: 'Academics' },
    { url: 'https://images.unsplash.com/photo-1768796370407-6d36619e7d6d?w=800&q=80', title: 'Workshop Session', category: 'Learning' },
    { url: 'https://images.unsplash.com/photo-1766297247924-6638d54e7c89?w=800&q=80', title: 'Computer Lab', category: 'Technology' },
  ];

  const cultural = [
    { url: 'https://images.unsplash.com/photo-1771736462659-786b163d291e?w=800&q=80', title: 'Cultural Festival', category: 'Culture' },
    { url: 'https://images.unsplash.com/photo-1742497360373-a399f83ec432?w=800&q=80', title: 'Art Exhibition', category: 'Art' },
    { url: 'https://images.unsplash.com/photo-1754531976838-436a70636c96?w=800&q=80', title: 'Leadership Summit', category: 'Conference' },
  ];
